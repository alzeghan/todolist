            ...
            <div class="well">
                ...
                <sf:form action="/user/todos/update.do" method="post" class="form-horizontal" modelAttribute="todo">
                    ...
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <input type="text" class="inpbox" id="id" name="id" value="${todo.id}" disabled="disabled"/>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <sf:input type="text" class="inpbox" id="title" path="title" value="${todo.title}" required="required" autofocus="autofocus" />
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <sf:input type="text" class="inpbox" id="dueDate" path="dueDate" required="required" />
                            </div>
                        </div>

                        <div class="control-group">
                            <label class="control-label" class="inpbox" for="status">Status:</label>
                            <div class="controls">
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btnsub"> <i class="icon-refresh icon-white"></i> Update</button>
                    ...
                    <script>
                        ...
                        $('#dueDate').datepicker("update", new Date());
                    </script>
