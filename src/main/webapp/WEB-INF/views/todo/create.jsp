                ...
                <sf:form id="createTodoForm" action="/user/todos/new.do" method="post" class="form-horizontal" modelAttribute="todo">
                    ...
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <sf:input type="text" class="inpbox" id="title" path="title" required="required" autofocus="autofocus" />
                            </div>
                        </div>
						...
						<div class="profile__footer form-actions" >
                            <button type="submit" class="btnsub"> <i class="icon-ok icon-white"></i> Create</button>
